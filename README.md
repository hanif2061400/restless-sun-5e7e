...
```
npm create cloudflare@latest -- --template=cloudflare/templates/restless-sun-5e7e
```

A live public deployment of this template is available at [https://restless-sun-5e7e.templates.workers.dev](https://restless-sun-5e7e.templates.workers.dev)
